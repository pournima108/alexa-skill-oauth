...
var base_url = "https://pournima.atlassian.net//"; //example https://test.atlassian.net
...
app.get('/jira', function(req, res) {
    ...
    var oa = new OAuth(base_url + "/plugins/servlet/oauth/request-token", //request token
        ...
        "mykey", //consumer key 
        fs.readFileSync('./rsa-key.pem', 'utf8'), //consumer secret, eg. fs.readFileSync('jira.pem', 'utf8')
        '1.0', //OAuth version
...
app.get('/projects', function(req, res) {
    var consumer = new OAuth(
        ...
        "mykey",
        fs.readFileSync('./rsa-key.pem', 'utf8'),
        '1.0',
